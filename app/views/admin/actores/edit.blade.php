...
<header class="panel-heading wht-bg">
   <h4 class="gen-case">Actor / Proceso: {{ $proceso->id }} / {{ $actor->nombre }}</h4>
</header>
<div class="row">
    <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        @endif
						<form action="{{ route('admin.procesos.actores.update', array($proceso->id, $actor->id)) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                            <input type="hidden" name="_method" value="PUT">
                            @include('admin.actores.partials.formedit')
