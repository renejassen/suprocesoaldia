            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        {{ Form::open(array('route' => 'admin.actuaciontipos.store')) }}
                        	@include('admin.actuacion_tipos.partials.formcreate')
                            <button type="submit" class="btn btn-primary">Crear</button>
                            <a href="{{ URL::route('admin.actuaciontipos.index') }}" class="btn btn-default">Cancelar</a>
                        {{ Form::close() }}
                    </div>
