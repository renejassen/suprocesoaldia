...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-angle-double-right"></i> Etapas</li>
        </ul>
        <!--breadcrumbs end -->
    </div>
</div>
<header class="panel-heading wht-bg">
   <h4 class="gen-case">Etapas</h4>
</header>
<div class="row">
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading">
                LISTA
                <span class="badge bg-default">{{ $etapas->count() }}</span>
            ...
            <div class="alert alert-success fade in">
                ...
                <strong>Bien hecho!</strong> etapa eliminada.
            </div>
            @endif
            ...
            <div class="alert alert-success fade in">
                ...
                <strong>Bien hecho!</strong> etapa creada.
            </div>
            @endif

            @if(Entrust::can('crear_etapas'))
            <a href="<?=URL::to('admin/etapas/create'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Crear</a>
            @endif
            ...
            <tr class="">
                ...
                <td>
                    <div class="botones">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ URL::route('admin.etapas.edit', $etapa->id) }}"><i class="fa fa-pencil"></i></a>
                        @endif
                        ...
                        {{ Form::button('<i class="fa fa-trash-o"></i>', array(
                                'onclick' =>    'showConfirmDeleteModal(
                                                    "' . $etapa->tipo . '",
                                                    "' . route('admin.etapas.destroy', $etapa->id) . '"
                                                )',
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Esta seguro de eliminar la etapa <strong><span id="deleteName"></span></strong>?
