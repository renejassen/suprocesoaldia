<div class="form-group {{ $errors->first('radicado', 'has-error') }}">
    ...
    {{ Form::text('radicado', '', array('class' => 'form-control')) }}
...
<div class="form-group {{ $errors->first('proceso_tipo_id', 'has-error') }}">
    ...
    {{ Form::select('proceso_tipo_id', $procesotipos = array('0' => 'Seleccionar') + ProcesoTipo::lists('tipo') , null, array('id' => 'proceso_tipo_id', 'class' => 'populate', 'style'  => 'width:100%')) }}
