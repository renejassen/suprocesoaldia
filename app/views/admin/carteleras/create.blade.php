        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-center">
                    ...
                    {{ Form::open(array('route' => array('admin.carteleras.store'), 'files' => 'true')) }}
                        @include('admin.carteleras.partials.formcreate')
                        <button type="submit" class="btn btn-primary">Crear</button>
                        {{ Form::button('Crear Despacho', array(
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{ Form::open(array('route' => array('admin.despachos.create.post'), 'files' => 'true', 'class' => 'create_despacho_ajax')) }}
                    ...
                    {{ Form::hidden('municipio_id', '', array('class' => 'form-control municipio_id', "id" => "municipio_id")) }}
            ...
            <div class="modal-footer">
                ...
                {{ Form::submit('Crear', array('class' => 'btn btn-primary', 'id' => 'buttonCreateDespacho')) }}
                {{ Form::close() }}
            </div>
        </div>
    </div>
        ...
        var form = $('.create_despacho_ajax');
            form.bind('submit',function () {
                $.ajax({
                    ...
                    data: form.serialize(),
                    beforeSend: function(){
                        $('.before').append('{{ HTML::image('admin/images/input-spinner.gif') }}');
                    },
