...
<div class="form-group {{ $errors->first('nit', 'has-error') }}">
    {{ Form::label('nit', 'Nit') }}
    {{ Form::text('nit', '', array('class' => 'form-control' , 'data-mask' => '999.999.999-9', 'placeholder' => '')) }}
...
<div class="form-group {{ $errors->first('nombres', 'has-error') }}">
    ...
    {{ Form::text('nombres', '', array('class' => 'form-control')) }}
...
<div class="form-group {{ $errors->first('telefono', 'has-error') }}">
    ...
    {{ Form::text('telefono', '', array('class' => 'form-control', 'data-mask' => '(999) 999 9999', 'placeholder' => '(031) 555 5555')) }}
    {{ $errors->first('telefono', '<p class="help-block">:message</p>') }}
</div>
<div class="form-group {{ $errors->first('celular', 'has-error') }}">
    {{ Form::label('celular', 'Celular') }}
    {{ Form::text('celular', '', array('class' => 'form-control', 'data-mask' => '(999) 999 9999', 'placeholder' => '(310) 555 5555')) }}
