            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        {{ Form::open(array('route' => 'admin.publicaciones.store')) }}
                        	@include('admin.publicaciones.partials.formcreate')
                            <button type="submit" class="btn btn-primary">Crear</button>
                            <a href="{{ URL::route('admin.publicaciones.index') }}" class="btn btn-default">Cancelar</a>
                        {{ Form::close() }}
                    </div>
