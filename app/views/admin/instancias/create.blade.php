...
<header class="panel-heading wht-bg">
   <h4 class="gen-case">Instancias / Proceso: <strong>{{ $proceso->id }}</strong></h4>
</header>
<div class="row">
    <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="alert alert-warning fade in">
                            ...
                            <strong>Lo sentimos!</strong> La instancia ya existe.
                            <a href="{{ URL::route('admin.procesos.edit', Session::get('proceso')) }}" class="btn btn-sm btn-warning">Ver proceso</a>
                        </div>
                        @endif

                        {{ Form::open(array('route' => array('admin.procesos.instancias.store', $proceso->id))) }}
                        	@include('admin.instancias.partials.formcreate')
